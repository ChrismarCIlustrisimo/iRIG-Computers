...
const StoreLocation = () => {
    ...
    const isStoreOpen = () => {
        ...
        // Check if time is between 9 AM and 6 PMs
  ...
  return (
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto p-6 mt-8 flex flex-col items-start justify-center gap-4 bg-light-container shadow-md mb-12 rounded-md">
      <div className="relative w-full h-[10%]" style={{ paddingBottom: '37.29%' }}>
            <iframe
    ...
    <div className="flex items-center justify-start w-full gap-2">
      <div className="w-full md:w-[25%] bg-light-button bg-opacity-10 text-light-button border border-light-button p-2 rounded-lg flex items-center justify-start gap-2 transform transition-all duration-300 hover:scale-110">
      ...
      >
        ...
        <div className="flex flex-col item-center justify-start text-black gap-4">
            ...
            <p className="font-bold mr-2">Store Hours: </p>
                <div className="flex gap-2 items-center w-full md:w-[50%]" onClick={() => setIsOpen(!isOpen)}>
                  {isOpen ? (
                    <>
                    ...
                    <div className="flex flex-col w-full gap-4 font-base">
                      <div className="flex items-center justify-between w-full sm:w-[68%]">
                        <p>Monday</p>
                        <div className="flex items-center justify-center gap-4">9 AM - 6 PM <BiSolidUpArrow size={10} /></div>
                      </div>
